        ...
        try {
            ...
            while (sc.hasNext()) {
                ...
                switch (HeroClasses.valueOf(heroClass.toLowerCase())){
                    case mage:
                        Mage mage = new MageBuilder().setName(name).setLevel(level).setExperiencePnts(xpPnts).setMaxHitPnts(maxHpPnts).setCurrentHp(currentHp).setMaxAttackPnts(attackPnts).setMaxDefencePnts(maxDefencePnts).setCurrentDefence(currentDefence).setBackpack(backpack).setEquipped(equipped).createMage();
                        mage.setCurrentMission(mission);
                        heroList.add(mage);
                        break;
                    ...
                    case warrior:
                        Warrior warrior = new WarriorBuilder().setName(name).setLevel(level).setExperiencePnts(xpPnts).setMaxHitPnts(maxHpPnts).setCurrentHp(currentHp).setMaxAttackPnts(attackPnts).setMaxDefencePnts(maxDefencePnts).setCurrentDefence(currentDefence).setBackpack(backpack).setEquipped(equipped).createWarrior();
                        warrior.setCurrentMission(mission);
