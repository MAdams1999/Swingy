...
public class ItemFactory extends Global {
    ...
    private static String[] adjectives = {"Mighty", "Frail", "Over-Powered", "Hardened", "Master", "Old", "Enchanted"};
    private static String[] hatType = {"Hood", "Helmet", "Top_Hat", "Crown"};
    private static String[] armourType = {"Leather_chest", "Dragon_chestplate", "Ebony_chest_piece", "Cloth_shirt"};
